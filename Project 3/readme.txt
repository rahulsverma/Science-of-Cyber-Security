...
3. Copy the folder "sqli3" to "C:\xampp\phpMyAdmin".

4. Go to "127.0.0.1/phpmyadmin/sqli3/index.php" in your browser.
...
6. For attempting SQL Injection enter any one of the statements as both username and password: 
   a) 1' or '1' = '1
   b) 1' or '1' = '1' and user<>'user1
   c) 1' or '1' = '1' and user<>'user1' and user<>'user2

7. SQLI attempt fails as we have implemented Prepared Statement, MySQLI Real Escape String and Input Validation prevention mechanisms.